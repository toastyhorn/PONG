...
export var wallSound = new soundFile("wallnew.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("paddlehit.mp3");
...
export var adventureMusic = new soundFile("thefatrat.mp3");
